...
module.exports.GenCC = function (CardScheme, howMany, randomGen) {
  ...
  if (typeof module.exports.Schemes[CardScheme] != "undefined") {
    return credit_card_number(module.exports.Schemes[CardScheme].prefixList, module.exports.Schemes[CardScheme].digitCount, amount);
  } else {
    // Defaults to MasterCard
    return credit_card_number(module.exports.Schemes["MasterCard"].prefixList, module.exports.Schemes["MasterCard"].digitCount, amount);
  }
};