  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <TextField 
            hintText="Dit fulde navn" fullWidth={true} name="name" value={this.state.name} onChange={this.onChange}
            errorText={errors.name}
          /><br />

          <TextField 
            hintText="Vælg et Brugernavn" fullWidth={true} name="username" value={this.state.username} onChange={this.onChange}
             errorText={errors.username}
          /><br />
           <TextField 
            hintText="email " fullWidth={true} name="email" value={this.state.email} onChange={this.onChange}
             errorText={errors.email}
          />
             <br />
          <TextField
            hintText="Indtast adgangskode" fullWidth={true} type="password" name="password" value={this.state.password} onChange={this.onChange}
           errorText={errors.password}
          />
          <TextField 
            hintText="Gentag adgangskode" fullWidth={true} type="password" name="passwordConfirmation" value={this.state.passwordConfirmation} onChange={this.onChange}
