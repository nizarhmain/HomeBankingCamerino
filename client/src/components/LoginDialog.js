...
export class LoginDialog extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <FlatButton icon={<LoginDude />} className="loginButton" label="Login"  onTouchTap={this.handleOpen}/>
				<Dialog
					title="Login"
					actions={actions}
					modal={false}
				...
				>
			 <TextField 
					 hintText="Brugernavn" fullWidth={true} name="username" value={this.state.username} onChange={this.onChange}
						errorText={errors.username}
					/><br />
						 <br />
					<TextField
					 hintText="Adgangskoden" fullWidth={true} name="password" value={this.state.password} onChange={this.onChange} type="password"
